...
class HoughLine():
    ...
    def callback(self, image_msg):
        ...
        def draw_lane(img, slope, color=(255, 0, 0), thickness=3):
            x1 = width / 2
            y1 = height - 50
            x2 = (y2 - y1)/(slope) + x1
            y2 = height / 2 - 50
        ...
        lane_img = draw_lane(result, slope1)
        ...
        result2 = cv2.addWeighted(image, 1, lane_img, 1, 0)
        cv2.imshow('result2', result2), cv2.waitKey(1)
